        ...
        return Core.user.apiToken != null
            ...
            : InkWell(
                child: Container(
                  ...
                  width: MediaQuery.of(context).size.width - 100,
                  padding: EdgeInsets.symmetric(vertical: 12),
                  decoration: BoxDecoration(borderRadius: BorderRadius.circular(8), color: AppColors.orangeColor),
                  child: Center(
                    child: Text(
                      'Log in/Sign Up'.tr,
                      style: TextStyle(fontSize: 14, fontFamily: FontFamily.vazirBold, color: Get.theme.secondaryHeaderColor),
                    ),
                  ),
                ),
              );
