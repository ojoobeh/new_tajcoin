...
import 'calculator_spinner_list_widget.dart';

class CalculatorAWidget extends GetView<CalculatorController> {
  const CalculatorAWidget({Key? key}) : super(key: key);
      ...
      child: Row(
        children: <Widget>[
          Container(
            ...
            child: CalculatorSpinnerListWidget(),
          ),
          Container(
            height: 50,
            width: 1,
