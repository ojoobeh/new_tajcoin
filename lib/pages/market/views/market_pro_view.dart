...
import '../../trader/views/webview_view.dart';
...
import '../widgets/market_percentage_pro_widget.dart';

class MarketProView extends GetView<MarketController> {
  @override
                                ...
                                child: Column(
                                  children: <Widget>[
                                            ...
                                            children: <Widget>[
                                              Container(
                                                ...
                                                child: Center(
                                                  child: Text(
                                                    "Market".tr,
                                                    style: TextStyle(fontSize: 12, color: context.theme.dividerColor),
                                                  ),
                                                ),
                                              ),
                                              InkWell(
                                                onTap: () => controller.setIsLimit(true),
                                                child: Container(
                                                  width: 80,
                                                  height: 25,
                                                  decoration: BoxDecoration(
                                            ...
                                            child: Obx(() {
                                              return Text(
                                                !controller.isSell.value
                                                    ? "Budget ".tr + " (USDT)"
                                                    : "Budget ".tr + "(${controller.selectMarketList.value.symbol.replaceAll("USDT", "").replaceAll("-", "")})",
                                                style: TextStyle(
                                                  fontFamily: FontFamily.vazirLight,
                                                ),
                                              );
                                              ...
                                              child: Row(
                                                ...
                                                children: <Widget>[
                                                  ...
                                                  Expanded(
                                                    child: Center(
                                                      child: MarketCustomFormFiled(
                                                        //int.parse(controller.selectMarketList.value.decimal)
                                    ...
                                    Container(
                                      ...
                                      child: MarketPercentageProWidget(),
                                    ),
                                    Container(
                                      margin: const EdgeInsets.only(top: 8),
                                      child: Row(
                                    ...
                                    Obx(() {
                                      return controller.isSell.value
                                          ? InkWell(
                                              onTap: () => controller.sellOrderPro(context),
                                              child: Container(
                                                height: 32,
                                                margin: const EdgeInsets.only(top: 8),
                                          ...
                                          : InkWell(
                                              onTap: () => controller.buyOrderPro(context),
                                              child: Container(
                                                height: 32,
                                                margin: const EdgeInsets.only(top: 8),
                                                width: MediaQuery.of(context).size.width - 100,
