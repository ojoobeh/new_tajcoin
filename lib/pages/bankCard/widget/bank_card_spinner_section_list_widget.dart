...
class BankCardSpinnerSectionListWidget extends GetView<BankCardController> {
  String iconData;

  BankCardSpinnerSectionListWidget(this.iconData);

  @override
  Widget build(final BuildContext context) {
    return Obx(() {
      return  controller.bankNameList.length > 0
          ? Directionality(
                  ...
                  children: <Widget>[
                    Container(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          DropdownButton<DataBank>(
                            dropdownColor: Get.theme.scaffoldBackgroundColor,
                            value: controller.selectBankName.value,
                            ...
                            onChanged: (DataBank? value) {
                              controller.selectIndexCategory(value!);
                            },
                            items: controller.bankNameList.map((DataBank vahed) {
                              return DropdownMenuItem<DataBank>(
                                value: vahed,
                                child: Container(
                                  width: 150,
                                  child: Text(
